...
alias gcb='cd ~/git/check_mk_2.4.0 && git checkout 2.4.0 && git pull'
alias gcs='cd ~/git/check_mk_2.3.0 && git checkout 2.3.0 && git pull'
alias gco='cd ~/git/check_mk_2.2.0 && git checkout 2.2.0 && git pull'
alias gca='cd ~/git/check_mk_2.1.0 && git checkout 2.1.0 && git pull'
...
alias teamspeak='teamspeak </dev/null &>/dev/null &'
