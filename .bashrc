...
alias unittest='_ut() { sudo ~/git/check_mk/scripts/run-pipenv run py.test -vv -T unit ~/git/check_mk/tests/unit -k "$1"; }; _ut'
alias unittests='sudo make -C ~/git/check_mk/tests test-unit'
alias omd='sudo omd'
